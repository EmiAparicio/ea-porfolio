import { qrToCenterAtom } from '@project/atoms/hexGridAtoms';
import { OUTSIDE_POSITION } from '@project/hooks/hexgrid/useGlobalPositions';
import { PixelPos, QrToCenter } from '@project/types/buttons-panel';
