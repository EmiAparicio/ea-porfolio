...
import Resume from '@portfolio/components/PageModals/EngModal/Resume';
import PaperSvg from '@portfolio/components/Svg/PaperSvg';
import ResearchSvg from '@portfolio/components/Svg/ResearchSvg';
